...
int main(void){
  ...
  std::string filenameData 
    ("data/clustering/test/sparse_circle2.txt");
  ...
  ifs >> data_number;
  ifs >> data_dimension;
  K_BFCM test(data_dimension, data_number, centers_number, 1.001, 64.0);
  //読み込んだデータを格納
  ...
  while(1){
    ...
    //クラスタ中心の収束具合
    double diff_v=max_norm(test.tmp_kernelcenters()-test.kernelcenters());
    //クラスタ混合比の収束具合
